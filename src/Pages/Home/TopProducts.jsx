                    ...
                    products?.map(product => <div key={product._id}>
                        <div className="card card-compact bg-base-100 shadow-xl">
                            ...
                            <div className="card-body gr">
                                ...
                                <Link to={`/details/${product._id}`}><button className="btn btn-outline btn-sm border p-2 rounded-full border-amber-600 hover:text-white hover:bg-black hover:border-black">Show Details</button></Link>
                            </div>
                        </div>
                    </div>)
                }
